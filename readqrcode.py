...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_6.setGeometry(QtCore.QRect(10, 105, 71, 16))
        ...
        self.data_3 = QtWidgets.QLineEdit(parent=self.groupBox_4)
        self.data_3.setGeometry(QtCore.QRect(80, 105, 281, 21))
        self.data_3.setReadOnly(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Số lượng QR : "))
    ...
    def de_qrcode(self, img):
        ...
        for barcode in decode(img_rotated):
            if barcode.type == 'QRCODE':
                ...
                break
        barcodes = pyzbar.decode(cv.cvtColor(img, cv.COLOR_BGR2GRAY))
        soluong = len(barcodes)
        self.data_3.setText(str(soluong))
        if decoded_data:
